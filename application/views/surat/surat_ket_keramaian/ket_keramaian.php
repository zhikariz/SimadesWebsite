        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" maxlength="16" name="nik" id="nik" placeholder="NIK Pemohon" value="<?php echo $nik; ?>" />
                    </div>
                    <div class="col-sm-1">
                ...
                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Dalam rangka <?php echo form_error('rangka') ?></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="rangka" id="rangka" placeholder="Dalam rangka" value="<?php echo $rangka; ?>"/>
                    </div>
                </div>
