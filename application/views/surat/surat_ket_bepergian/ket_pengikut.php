    ...
    <div class="box">
        ...
        <center><h4><b>DATA PENGIKUT </b></h4></center>
        <br>
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" maxlength="16" name="nik" id="nik" placeholder="NIK Pengikut" value="<?php echo $nik; ?>" />
                    </div>
                    <div class="col-sm-1">
                ...
                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Keterangan <?php echo form_error('keterangan') ?></label>
                    <div class="col-sm-8">
             ...
             <input type="hidden" name="kd_surat" value="<?php echo $kd_surat?>">
