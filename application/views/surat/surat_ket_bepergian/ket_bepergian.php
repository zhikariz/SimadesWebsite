    ...
    <div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Alamat Asal<?php echo form_error('alamat') ?></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <textarea class="form-control" rows="3" name="alamat_tuju" id="alamat_tuju" placeholder="Alamat Tujuan"><?php echo $alamat_tuju; ?></textarea>
                    </div>
                </div>

                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Keperluan <?php echo form_error('alasan') ?></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="alasan" id="alasan" placeholder="Keperluan" value="<?php echo $alasan; ?>"/>
                    </div>
                </div>
            ...
            <div class="box-footer">
                ...
                <input type="submit" name="submit" value="Tambah Pengikut" class="btn btn-primary" />
