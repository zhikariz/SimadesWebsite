...
<body>
	...
	<table width="100%">
		<tr>
			...
			<td width="30" align="center">
				 ...
				 <i>Alamat : <?php echo $alamat_desa?> Telp. <?php echo $no_telp?> Kode Pos <?php echo $kode_pos?></i> </font>
			</td>
	...
	<table width="100%" style="margin-top: 10px; margin-bottom: 8px;">
		...
		<tr>
			<td width="60px"></td><td width="170px"><small> NIK </small></td><td width="12px"> : </td><td><small> <?php echo $nik?> </small></td>
		...
		<tr>
			<td width="60px"></td><td width="170px" valign="top"><small> Keperluan </small></td><td width="12px" valign="top"> : </td><td align="justify"><small> <?php echo $keperluan?> </small></td>
			
		</tr>
		<tr>
			<td width="60px"></td><td width="170px" valign="top"><small> Berlaku mulai </small></td><td width="12px" valign="top"> : </td><td align="left"><small> <?php echo $berlaku_mulai?> </small></td>
	...
	<table width="100%">
		<tr> 
			<td width="100px"></td><td width="80px" align="left"><small><br></small></td><td width="100px" align="center"><small> <?php echo $desa?>, <?php echo $tgl_surat?> <br> <?php echo $jabatan?> <?php echo $desa?> </small></td>
		</tr>
		<tr> 
