...
<body>
	...
	<table width="100%" style="margin-top: 10px; margin-bottom: 8px;">
		...
		<tr>
			<td width="30px"><small>8.</small></td><td width="170px"><small> Surat bukti diri </small></td><td width="12px"> : </td><td><small> <?php echo $bukti?> </small></td>

		</tr>

		<tr>
			<td width="30px" valign="top"><small>9.</small></td><td width="170px" valign="top"><small> Permohonan KTP </small></td><td width="12px" valign="top"> : </td><td align="justify"><small> <?php echo $ket_permohonan?> </small></td>

		</tr>

		<tr>
			<td width="30px"><small>10.</small></td><td width="170px"><small> Berlaku mulai </small></td><td width="12px"> : </td><td><small> <?php echo $berlaku_mulai?> </small></td>

		</tr>


	</table>
	<small>Demikian untuk menjadikan maklum bagi yang berkepentingan</small>
	<br>
	<br>
	<br>
	<br>
	...
	<table width="100%">
		<tr>
			<td width="100px"></td><td width="80px" align="left"><small><br></small></td><td width="100px" align="center"><small> <?php echo $desa?>, <?php echo $tgl_surat?> <br> Pemohon </small></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="100px"><small></small></td><td width="80px" align="left"><small><b><u></u></b></small></td><td width="100px" align="center"><small><b><u><?php echo $nama?></u></b></small></td>
		</tr>
    <tr>
      <td width="100px"></td><td width="80px" align="left"><small><br> Camat <?php echo $kecamatan ?>,</small></td><td width="100px" align="center"><small> <br> <?php echo $jabatan?> <?php echo $desa?> </small></td>
    </tr>
    <tr>
      <td width="100px"><small></small></td><td width="80px"></td><td width="100px" align="center"></td>
    </tr>
    ...
    <tr>
      <td width="100px"><small></small></td><td width="80px" align="left"><small><b><u><?php echo "_____________________"?></u></b></small></td><td width="100px" align="center"><small><b><u><?php echo $nama_pejabat?></u></b></small></td>
    </tr>
