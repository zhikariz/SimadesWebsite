    ...
    <div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
            ...
            <br>
                ...
                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">NIK <?php echo form_error('nik_wali') ?></label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" maxlength="16" name="nik" id="nik_wali" placeholder="NIK" value="<?php echo $nik; ?>" />
                    </div>
                    <div class="col-sm-1">
                        <button  class="btn btn-info" onclick="open_child('<?php echo site_url("lookup/dataortu")?>','Look Up','1200','500'); return false;"> Cari Data </button>
                    </div>
                </div>
                <div class="form-group">
