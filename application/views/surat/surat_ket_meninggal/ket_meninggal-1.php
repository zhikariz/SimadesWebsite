    ...
    <div class="box">
        ...
        <center><h4><b>DATA PENGAJU / SAKSI 1</b></h4></center>
        <br>
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">NIK Pengaju<?php echo form_error('nik') ?></label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" maxlength="16" name="nik" id="nik" placeholder="NIK Pengaju" value="<?php echo $nik; ?>" />
                    </div>
                    <div class="col-sm-1">
