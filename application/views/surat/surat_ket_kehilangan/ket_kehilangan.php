    ...
    <div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Barang Hilang <?php echo form_error('barang') ?></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="barang" id="barang" placeholder="Barang Hilang" value="<?php echo $barang; ?>"/>
                    </div>
                </div>

                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Sebab Hilang <?php echo form_error('sebab') ?></label>
                    <div class="col-sm-8">
                        <?php
                        $options = array(
                            NULL => '---',
                        ...
                        echo form_dropdown('sebab', $options, $sebab, array('class' => 'form-control'));
                        ?>
                    </div>
               ...
               <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Tempat Hilang <?php echo form_error('tpt_hilang') ?></label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="tpt_hilang" id="tpt_hilang" placeholder="Tempat Hilang" value="<?php echo $tpt_hilang; ?>" />
                    </div>

                    <label for="varchar" class="col-sm-2 control-label">Tanggal Hilang <?php echo form_error('tgl_hilang') ?></label>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" name="tgl_hilang" id="tgl_hilang" placeholder="Tanggal Hilang" value="<?php echo $tgl_hilang; ?>" />
                    </div>
                </div>
