    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nm_desa" id="nm_desa" placeholder="Nama Desa"  onkeypress="return isNumberKey(event)"  value="<?php echo $nm_desa; ?>" />
        </div>
      <div class="form-group">
      ...
      <div class="form-group">
            ...
            <input type="text" class="form-control" name="kabupaten" id="kabupaten" placeholder="Kabupaten"  onkeypress="return isNumberKey(event)" value="<?php echo $kabupaten; ?>" />
        </div>
        <div class="form-group">
            <label for="varchar">Propinsi <?php echo form_error('propinsi') ?></label>
            <input type="text" class="form-control" name="propinsi" id="propinsi" placeholder="Propinsi" onkeypress="return isNumberKey(event)" value="<?php echo $propinsi; ?>" />
        </div>
      <div class="form-group">
            <label for="varchar">Nama Kepdes <?php echo form_error('nm_kepdes') ?></label>
            <input type="text" class="form-control" name="nm_kepdes" id="nm_kepdes" placeholder="Nama Kepdes" onkeypress="return isNumberKey(event)" value="<?php echo $nm_kepdes; ?>" />
        </div>
      <div class="form-group">
            <label for="varchar">NIP Kepdes <?php echo form_error('nip_kepdes') ?></label>
            <input type="text" class="form-control" name="nip_kepdes" id="nip_kepdes" placeholder="NIP Kepdes" value="<?php echo $nip_kepdes; ?>" />
        </div>
      <div class="form-group">
