                ...
                <div class="box-body">
            	    ...
            	    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kd_desa" id="kd_desa" maxlength="7" placeholder="Kode Desa" onkeypress="return isNumberKeyTrue(event)"
                          value="<?php echo $kode_desa; ?>" readonly/>
                    </div>
                    <div class="form-group">
                        <label for="varchar">Nama Desa <?php echo form_error('nm_desa') ?></label>
                        <input type="text" class="form-control" name="nm_desa" id="nm_desa" placeholder="Nama Desa"  onkeypress="return isNumberKey(event)"  value="<?php echo $nm_desa; ?>" readonly/>
                    </div>
            	    <div class="form-group">
                        <label for="varchar">Kecamatan <?php echo form_error('kecamatan') ?></label>
                        <input type="text" class="form-control" name="kecamatan" id="kecamatan"   placeholder="Kecamatan" onkeypress="return isNumberKey(event)" value="<?php echo $kecamatan; ?>" readonly/>
                    </div>
            	    <div class="form-group">
                        <label for="varchar">Kabupaten <?php echo form_error('kabupaten') ?></label>
                        <input type="text" class="form-control" name="kabupaten" id="kabupaten" placeholder="Kabupaten"  onkeypress="return isNumberKey(event)" value="<?php echo $kabupaten; ?>" readonly/>
                    </div>
                    <div class="form-group">
                        <label for="varchar">Propinsi <?php echo form_error('propinsi') ?></label>
                        <input type="text" class="form-control" name="propinsi" id="propinsi" placeholder="Propinsi" onkeypress="return isNumberKey(event)" value="<?php echo $propinsi; ?>" readonly/>
                    </div>
            	    <div class="form-group">
            	    ...
            	    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" name="alamat_desa" id="alamat_desa" placeholder="Alamat Desa" readonly><?php echo $alamat_desa; ?></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="no_telp" id="no_telp" placeholder="Nomor Telepon" onkeypress="return isNumberKeyTrue(event)"
                         value="<?php echo $no_telp; ?>" readonly/>
                    </div>
            	    <div class="form-group">
                        ...
                        value="<?php echo $kode_pos; ?>" readonly/>
                    </div>
                    <div class="form-group">
                       <label for="varchar">Logo Desa <?php echo form_error('logo_desa') ?></label>
                       <!-- <input type="file" name="logo_desa" id="logo_desa" readonly/> -->
                        <br>
                    <?php
                    if($logo_desa)
                            {
