    ...
    <div class="box">
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="nik_pend" id="nik_pend" placeholder="NIK" maxlength="16" size="16" onkeypress="return isNumberKeyTrue(event)" value="<?php echo $nik; ?>" />
        </div>
        <div class="form-group">
