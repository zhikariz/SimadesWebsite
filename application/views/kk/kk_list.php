...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $kk->kabupaten ?></td>
			<td><?php echo $kk->propinsi ?></td>
			<td><?php echo $kk->kode_pos ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kk/read/'.$kk->no_kk),'Read'); 
				echo ' | '; 
				echo anchor(site_url('kk/update/'.$kk->no_kk),'Update'); 
				echo ' | '; 
				echo anchor(site_url('kk/delete/'.$kk->no_kk),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
