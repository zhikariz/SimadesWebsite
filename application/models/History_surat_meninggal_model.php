...
class History_surat_meninggal_model extends CI_Model
{

    public $table = 'history_surat_meninggal';
    public $id = 'history_surat_meninggal.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('surat_ket_meninggal','history_surat_meninggal.kd_surat = surat_ket_meninggal.kd_surat');
    ...
    {
        $this->db->where($this->id, $id);
        $this->db->join('surat_ket_meninggal','surat_ket_meninggal.kd_surat = history_surat_meninggal.kd_surat');
