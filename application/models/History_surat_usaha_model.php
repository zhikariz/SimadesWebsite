...
class History_surat_usaha_model extends CI_Model
{

    public $table = 'history_surat_usaha';
    public $join_table = 'surat_ket_usaha';
    public $join = 'history_surat_usaha.kd_surat = surat_ket_usaha.kd_surat';
    public $id = 'history_surat_usaha.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('penduduk', 'surat_ket_usaha.nik = penduduk.nik');
