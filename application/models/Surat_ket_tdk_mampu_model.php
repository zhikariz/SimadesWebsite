...
class Surat_ket_tdk_mampu_model extends CI_Model
{

    public $table = 'surat_ket_tdk_mampu';
    public $id = 'kd_surat';
    public $order = 'DESC';
    ...
    function get_kode(){
        $this->db->select('right(surat_ket_tdk_mampu.kd_surat,4) as kode',false);
            $this->db->order_by('kd_surat','desc');
        $this->db->limit(1);
        $query=$this->db->get('surat_ket_tdk_mampu');
    ...
    function get_all()
    {
        ...
        $this->db->join('user', 'user.id_user = surat_ket_tdk_mampu.id_user_ttd');
