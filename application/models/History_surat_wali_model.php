...
class History_surat_wali_model extends CI_Model
{

    public $table = 'history_surat_wali';
    public $join_table = 'surat_ket_wali';
    public $join = 'history_surat_wali.kd_surat = surat_ket_wali.kd_surat';
    public $id = 'history_surat_wali.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('penduduk', 'surat_ket_wali.nik = penduduk.nik');
