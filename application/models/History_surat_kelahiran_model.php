...
class History_surat_kelahiran_model extends CI_Model
{

    public $table = 'history_surat_kelahiran';
    public $id = 'history_surat_kelahiran.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('surat_ket_lahir','history_surat_kelahiran.kd_surat = surat_ket_lahir.kd_surat');
        $this->db->join('penduduk', 'surat_ket_lahir.nik = penduduk.nik');
    ...
    {
        $this->db->where($this->id, $id);
        $this->db->join('surat_ket_lahir','surat_ket_lahir.kd_surat = history_surat_kelahiran.kd_surat');
