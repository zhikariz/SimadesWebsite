...
class History_surat_tdk_mampu_model extends CI_Model
{

    public $table = 'history_surat_tdk_mampu';
    public $id = 'history_surat_tdk_mampu.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('surat_ket_tdk_mampu','history_surat_tdk_mampu.kd_surat = surat_ket_tdk_mampu.kd_surat');
        $this->db->join('penduduk', 'surat_ket_tdk_mampu.nik = penduduk.nik');
    ...
    {
        $this->db->where($this->id, $id);
        $this->db->join('surat_ket_tdk_mampu','surat_ket_tdk_mampu.kd_surat = history_surat_tdk_mampu.kd_surat');
