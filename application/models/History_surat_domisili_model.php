...
class History_surat_domisili_model extends CI_Model
{

    public $table = 'history_surat_domisili';
    public $join_table = 'surat_ket_domisili';
    public $join = 'history_surat_domisili.kd_surat = surat_ket_domisili.kd_surat';
    public $id = 'history_surat_domisili.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('penduduk', 'surat_ket_domisili.nik = penduduk.nik');
