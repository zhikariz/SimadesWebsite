...
class History_surat_keramaian_model extends CI_Model
{

    public $table = 'history_surat_keramaian';
    public $join_table = 'surat_ket_keramaian';
    public $join = 'history_surat_keramaian.kd_surat = surat_ket_keramaian.kd_surat';
    public $id = 'history_surat_keramaian.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('penduduk', 'surat_ket_keramaian.nik = penduduk.nik');
