...
class Surat_ket_domisili_model extends CI_Model
{

    public $table = 'surat_ket_domisili';
    public $join = 'user.id_user = surat_ket_domisili.id_user_ttd';
    public $id = 'kd_surat';
    public $order = 'DESC';
    ...
    function get_kode(){
        $this->db->select('right(surat_ket_domisili.kd_surat,4) as kode',false);
            $this->db->order_by('kd_surat','desc');
        $this->db->limit(1);
        $query=$this->db->get('surat_ket_domisili');
