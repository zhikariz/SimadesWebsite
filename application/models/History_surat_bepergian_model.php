...
class History_surat_bepergian_model extends CI_Model
{

    public $table = 'history_surat_bepergian';
    public $join_table = 'surat_ket_bepergian';
    public $join = 'history_surat_bepergian.kd_surat = surat_ket_bepergian.kd_surat';
    public $id = 'history_surat_bepergian.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('penduduk', 'surat_ket_bepergian.nik = penduduk.nik');
