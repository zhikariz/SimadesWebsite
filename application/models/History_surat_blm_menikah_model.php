...
class History_surat_blm_menikah_model extends CI_Model
{

    public $table = 'history_surat_blm_menikah';
    public $join_table = 'surat_ket_blm_menikah';
    public $join = 'history_surat_blm_menikah.kd_surat = surat_ket_blm_menikah.kd_surat';
    public $id = 'history_surat_blm_menikah.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('penduduk', 'surat_ket_blm_menikah.nik = penduduk.nik');
