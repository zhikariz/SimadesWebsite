...
class History_surat_pengantar_model extends CI_Model
{

    public $table = 'history_surat_pengantar';
    public $join_table = 'surat_ket_pengantar';
    public $join = 'history_surat_pengantar.kd_surat = surat_ket_pengantar.kd_surat';
    public $id = 'history_surat_pengantar.kd_surat';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $c=NULL, $q = NULL) {
        ...
        $this->db->join('penduduk', 'surat_ket_pengantar.nik = penduduk.nik');
