...
//Surat Keterangan Meninggal
    ...
    public function ket_meninggal_2($id)
    {
            ...
            'nama_saksi1' => set_value('nama_saksi1'),
            'umur_saksi1' => set_value('umur_saksi1'),
    ...
    function ket_meninggal_action($id) {
        $this->_rules_meninggal();

        if ($this->form_validation->run() == FALSE) {
            $this->ket_meninggal_1($id);
        } else {
            ...
            $data_surat = array(
                ...
                'nik' => $this->input->post('nik', TRUE), 
                'nama_saksi1' => $this->input->post('nama_saksi1', TRUE),
                'umur_saksi1' => $this->input->post('umur_saksi1', TRUE),
                'alamat_saksi1' => $this->input->post('alamat_saksi1', TRUE),
                'nama_saksi2' => $this->input->post('nama_saksi2', TRUE), 
            ...
            redirect(site_url('surat/cetak_ket_meninggal/'.$kode));
        }
    }
    ...
    function cetak_ket_meninggal($kode) {
        ...
        $data_meninggal = $this->Penduduk_model->get_by_id($data_surat->nik);
        //$data_ayah = $this->Penduduk_model->get_by_id($data_surat->nik_ayah);
        //$data_ibu = $this->Penduduk_model->get_by_id($data_surat->nik_ibu);
...
//Surat Keterangan Tidak Mampu
    ...
    function ket_tdk_mampu_action($id) {
        $this->_rules_tdk_mampu();

        if ($this->form_validation->run() == FALSE) {
            $this->ket_tdk_mampu_2($id);
        } else {
            ...
            redirect(site_url('surat/cetak_ket_tdk_mampu/'.$kode));
        }
    }
    ...
    function ket_bepergian_action($id) {
        $this->_rules_bepergian();

        if ($this->form_validation->run() == FALSE) {
            $this->ket_bepergian($id);
        } else {
            ...
            if($this->input->post('submit')=='Tambah Pengikut'){
               ...
               redirect(site_url('surat/cetak_ket_bepergian/'.$kode));
    ...
    function ket_blm_menikah_action($id) {
        $this->_rules_blm_menikah();

        if ($this->form_validation->run() == FALSE) {
            $this->ket_blm_menikah($id);
        } else {
            $data_desa = $this->Profil_desa_model->get_by_id(1);
            ...
            redirect(site_url('surat/cetak_ket_blm_menikah/'.$kode));
        }
    }
    ...
    function ket_usaha_action($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('surat/cetak_ket_usaha/'.$kode));
        }
    }
    ...
    function ket_pengantar_action($id) {
        $this->_rules_pengantar();

        if ($this->form_validation->run() == FALSE) {
            $this->ket_pengantar($id);
        } else {
            $data_desa = $this->Profil_desa_model->get_by_id(1);
            ...
            redirect(site_url('surat/cetak_ket_pengantar/'.$kode));
        }
    }
    ...
    function ket_wali_action($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('surat/cetak_ket_wali/'.$kode));
        }
    }
    ...
    function ket_kehilangan_action($id) {
        $this->_rules_kehilangan();

        if ($this->form_validation->run() == FALSE) {
            $this->ket_kehilangan($id);
        } else {
            $data_desa = $this->Profil_desa_model->get_by_id(1);
            ...
            redirect(site_url('surat/cetak_ket_kehilangan/'.$kode));
        }
    }
    ...
    function ket_keramaian_action($id) {
        $this->_rules_keramaian();

        if ($this->form_validation->run() == FALSE) {
            $this->ket_keramaian($id);
        } else {
            $data_desa = $this->Profil_desa_model->get_by_id(1);
            ...
            redirect(site_url('surat/cetak_ket_keramaian/'.$kode));
        }
    }
